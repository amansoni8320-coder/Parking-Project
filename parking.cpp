...

{
...

	{
		...
		cout<<"Total Number Of Cars In The Parking Area Is : "<<car<<endl<<endl;

		cout<<"Total Number Of Bikes In The Parking Area Is : "<<bike<<endl<<endl;

		cout<<"Total Number Of Rikshaws In The Parking Area Is : "<<rikshaw<<endl<<endl;
